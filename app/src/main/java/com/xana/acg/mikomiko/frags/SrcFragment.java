...
public class SrcFragment extends PresenterFragment<AnimePlayerContract.Presenter>
        implements AnimePlayerContract.View, AnimePlayerActivity.OnFragListener {
    ...
    public void next() {
        ...
        mAapter.getListener().onItemClick((RecyclerAdapter.ViewHolder) rv.findViewHolderForAdapterPosition(p), mAapter.getItemList().get(p));
    }
